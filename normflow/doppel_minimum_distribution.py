...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 3:
        print("You need to give a data size and number of trials as arg1 arg2")
        sys.exit(1)
    ...
    if data1.shape[0]/(data_size*n_trials) < 1:
        print("Data size isn't big enough for the input args")
        sys.exit(1)
